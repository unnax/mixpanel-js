...
d=arguments[arguments.length-1];"function"===typeof d&&d(0)}}function ra(a,b,d){"GET"===a&&(b+="?"+c.vc(d));return b}var A=r,t;if("undefined"===typeof window){var B={hostname:""};t={navigator:{userAgent:""},document:{location:B,referrer:""},screen:{width:0,height:0},location:B}}else t=window;var B=Array.prototype,ea=Object.prototype,G=B.slice,J=ea.toString,S=ea.hasOwnProperty,x=t.console,H=t.navigator,o=t.document,K=t.opera,T=t.screen,w=H.userAgent,W=Function.prototype.bind,fa=B.forEach,ga=B.indexOf,
B=Array.isArray,X={},c={trim:function(a){return a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")}},q={log:function(){if(A&&!c.d(x)&&x)try{x.log.apply(x,arguments)}catch(a){c.a(arguments,function(a){x.log(a)})}},error:function(){if(A&&!c.d(x)&&x){var a=["Mixpanel error:"].concat(c.ka(arguments));try{x.error.apply(x,a)}catch(b){c.a(a,function(a){x.error(a)})}}},T:function(){if(!c.d(x)&&x){var a=["Mixpanel error:"].concat(c.ka(arguments));try{x.error.apply(x,a)}catch(b){c.a(a,function(a){x.error(a)})}}}};
c.bind=function(a,b){var d,e;if(W&&a.bind===W)return W.apply(a,G.call(arguments,1));if(!c.fb(a))throw new TypeError;d=G.call(arguments,2);return e=function(){if(!(this instanceof e))return a.apply(b,d.concat(G.call(arguments)));var c={};c.prototype=a.prototype;var j=new c;c.prototype=m;c=a.apply(j,d.concat(G.call(arguments)));return Object(c)===c?c:j}};c.Eb=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.bind(a[b],a))};c.a=function(a,b,d){if(!(a===m||void 0===a))if(fa&&a.forEach===fa)a.forEach(b,
d);else if(a.length===+a.length)for(var c=0,f=a.length;c<f&&!(c in a&&b.call(d,a[c],c,a)===X);c++);else for(c in a)if(S.call(a,c)&&b.call(d,a[c],c,a)===X)break};c.K=function(a){a&&c.za(a)&&(a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"));return a};c.extend=function(a){c.a(G.call(arguments,1),function(b){for(var d in b)void 0!==b[d]&&(a[d]=b[d])});return a};c.isArray=B||function(a){return"[object Array]"===J.call(a)};c.fb=function(a){try{return/^\s*\bfunction\b/.test(a)}catch(b){return r}};
c.ld=function(a){return!(!a||!S.call(a,"callee"))};c.ka=function(a){return!a?[]:a.ka?a.ka():c.isArray(a)||c.ld(a)?G.call(a):c.Od(a)};c.keys=function(a){var b=[];if(a===m)return b;c.a(a,function(a,c){b[b.length]=c});return b};c.Od=function(a){var b=[];if(a===m)return b;c.a(a,function(a){b[b.length]=a});return b};c.Vd=function(a){return a};c.Sb=function(a,b){var d=r;if(a===m)return d;if(ga&&a.indexOf===ga)return-1!=a.indexOf(b);c.a(a,function(a){if(d||(d=a===b))return X});return d};c.e=function(a,b){return-1!==
a.indexOf(b)};c.Ub=function(a,b){a.prototype=new b;a.Ed=b.prototype};c.k=function(a){return a===Object(a)&&!c.isArray(a)};c.eb=function(a){if(c.k(a)){for(var b in a)if(S.call(a,b))return r;return l}return r};c.d=function(a){return void 0===a};c.za=function(a){return"[object String]"==J.call(a)};c.nd=function(a){return"[object Date]"==J.call(a)};c.Wb=function(a){return"[object Number]"==J.call(a)};c.od=function(a){return!!(a&&1===a.nodeType)};c.Pb=function(a){c.a(a,function(b,d){c.nd(b)?a[d]=c.hd(b):
c.k(b)&&(a[d]=c.Pb(b))});return a};c.timestamp=function(){Date.now=Date.now||function(){return+new Date};return Date.now()};c.hd=function(a){function b(a){return 10>a?"0"+a:a}return a.getUTCFullYear()+"-"+b(a.getUTCMonth()+1)+"-"+b(a.getUTCDate())+"T"+b(a.getUTCHours())+":"+b(a.getUTCMinutes())+":"+b(a.getUTCSeconds())};c.l=function(a){return function(){try{return a.apply(this,arguments)}catch(b){q.T("Implementation error. Please turn on debug and contact support@mixpanel.com."),A&&q.T(b)}}};c.ud=
function(a){for(var b=["identify","_check_and_handle_notifications","_show_notification"],d=0;d<b.length;d++)a.prototype[b[d]]=c.l(a.prototype[b[d]])};c.vd=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.l(a[b]))};c.Aa=function(a){var b={};c.a(a,function(a,e){c.za(a)&&0<a.length&&(b[e]=a)});return b};c.truncate=function(a,b){var d;"string"===typeof a?d=a.slice(0,b):c.isArray(a)?(d=[],c.a(a,function(a){d.push(c.truncate(a,b))})):c.k(a)?(d={},c.a(a,function(a,f){d[f]=c.truncate(a,b)})):
d=a;return d};c.oa=function(){return function(a){function b(a,c){var j="",k=0,i=k="",i=0,g=j,h=[],s=c[a];s&&"object"===typeof s&&"function"===typeof s.toJSON&&(s=s.toJSON(a));switch(typeof s){case "string":return d(s);case "number":return isFinite(s)?""+s:"null";case "boolean":case "null":return""+s;case "object":if(!s)return"null";j+="    ";h=[];if("[object Array]"===J.apply(s)){i=s.length;for(k=0;k<i;k+=1)h[k]=b(k,s)||"null";return i=0===h.length?"[]":j?"[\n"+j+h.join(",\n"+j)+"\n"+g+"]":"["+h.join(",")+
"]"}for(k in s)S.call(s,k)&&(i=b(k,s))&&h.push(d(k)+(j?": ":":")+i);return i=0===h.length?"{}":j?"{"+h.join(",")+""+g+"}":"{"+h.join(",")+"}"}}function d(a){var b=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,d={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};b.lastIndex=0;return b.test(a)?'"'+a.replace(b,function(a){var b=d[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+
'"':'"'+a+'"'}return b("",{"":a})}}();c.na=function(){function a(){switch(i){case "t":return f("t"),f("r"),f("u"),f("e"),l;case "f":return f("f"),f("a"),f("l"),f("s"),f("e"),r;case "n":return f("n"),f("u"),f("l"),f("l"),m}j('Unexpected "'+i+'"')}function b(){for(;i&&" ">=i;)f()}function d(){var a,b,d="",c;if('"'===i)for(;f();){if('"'===i)return f(),d;if("\\"===i)if(f(),"u"===i){for(b=c=0;4>b;b+=1){a=parseInt(f(),16);if(!isFinite(a))break;c=16*c+a}d+=String.fromCharCode(c)}else if("string"===typeof h[i])d+=
h[i];else break;else d+=i}j("Bad string")}function c(){var a;a="";"-"===i&&(a="-",f("-"));for(;"0"<=i&&"9">=i;)a+=i,f();if("."===i)for(a+=".";f()&&"0"<=i&&"9">=i;)a+=i;if("e"===i||"E"===i){a+=i;f();if("-"===i||"+"===i)a+=i,f();for(;"0"<=i&&"9">=i;)a+=i,f()}a=+a;if(isFinite(a))return a;j("Bad number")}function f(a){a&&a!==i&&j("Expected '"+a+"' instead of '"+i+"'");i=g.charAt(k);k+=1;return i}function j(a){a=new SyntaxError(a);a.Sd=k;a.text=g;throw a;}var k,i,h={'"':'"',"\\":"\\","/":"/",b:"\u0008",
f:"\u000c",n:"\n",r:"\r",t:"\t"},g,s;s=function(){b();switch(i){case "{":var k;a:{var g,h={};if("{"===i){f("{");b();if("}"===i){f("}");k=h;break a}for(;i;){g=d();b();f(":");Object.hasOwnProperty.call(h,g)&&j('Duplicate key "'+g+'"');h[g]=s();b();if("}"===i){f("}");k=h;break a}f(",");b()}}j("Bad object")}return k;case "[":a:{k=[];if("["===i){f("[");b();if("]"===i){f("]");g=k;break a}for(;i;){k.push(s());b();if("]"===i){f("]");g=k;break a}f(",");b()}}j("Bad array")}return g;case '"':return d();case "-":return c();
...
(new Date).getTime(),function(){window.mp_load_editor(b)}),l):r},gd:function(a,b,d){for(var b=!c.d(b)?b:10,d=!c.d(d)?d:10,e=0,f=0;f<a.length;f++)e+=a.charCodeAt(f);return e%b<d},md:function(){return c.fb(document.querySelectorAll)}};c.Eb(I);c.vd(I);var qa="__mp_opt_in_out_",V,v,sa="__mps,__mpso,__mpus,__mpa,__mpap,__mpu,$people_distinct_id,__alias,__cmpns,__timers".split(","),U=t.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,$=!U&&-1===w.indexOf("MSIE")&&-1===w.indexOf("Mozilla"),ta={api_host:"https://api.mixpanel.com",
...
M.prototype.Ta=function(a,b){setTimeout(function(){b.element.submit()},0)};p.prototype.ia=function(){var a={};c.a(this.props,function(b,d){c.Sb(sa,d)||(a[d]=b)});return a};p.prototype.load=function(){if(!this.disabled){var a=this.v.parse(this.name);a&&(this.props=c.extend({},a))}};p.prototype.Md=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.v.parse(d),this.v.remove(d),this.v.remove(d,l),b&&(this.props=c.extend(this.props,b.all,b.events));if(!a.cookie_name&&
...
else if("mixpanel"===d)q.error("You must initialize the main mixpanel object right after you include the Mixpanel js snippet");else return a=L(a,b,d),v[d]=a,a.ra(),a};h.prototype.Pa=function(a,b,d){this.__loaded=l;this.config={};this.gc(c.extend({},ta,b,{name:d,token:a,callback_fn:("mixpanel"===d?d:"mixpanel."+d)+"._jsc"}));this._jsc=C();this.Ja=[];this.Ka=[];this.Ia=[];this.P={disable_all_events:r,identify_called:r};this.persistence=this.cookie=new p(this.config);this.Jc();this.D({distinct_id:c.ob()},
...
r;if(!Z)return this.Ja.push([a,b]),r;var c=(new a).V(this);return c.s.apply(c,b)};h.prototype.sa=function(a,b){if(c.d(a))return m;if(U)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.c("callback_fn")+"["+e+"]";d[e]=function(c){delete d[e];a(c,b)};return f};h.prototype.m=function(a,b,d){var e=a.e("decide")?"GET":"POST";if($)this.Ka.push(arguments);else{b.data=b.data?"data="+btoa("["+atob(b.data)+"]"):void 0;var f=this.c("verbose");b.verbose&&(f=l);this.c("test")&&
(b.test=1);f&&(b.verbose=1);this.c("img")&&(b.img=1);if(!U)if(d)b.callback=d;else if(f||this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();a=ra(e,a,b);if("img"in b)e=o.createElement("img"),e.src=a,o.body.appendChild(e);else if(U)try{var j=new XMLHttpRequest;j.open(e,a,l);c.a(this.c("xhr_headers"),function(a,b){j.setRequestHeader(b,a)});j.setRequestHeader("Content-type","application/x-www-form-urlencoded");j.withCredentials=l;j.onreadystatechange=function(){if(4===
j.readyState)if(200===j.status){if(d)if(f){var a;try{a=c.na(j.responseText)}catch(b){q.error(b);return}d(a)}else d(Number(j.responseText))}else a="Bad HTTP status: "+j.status+" "+j.statusText,q.error(a),d&&(f?d({status:0,error:a}):d(0))};"GET"===e?j.send(b.data):j.send()}catch(g){q.error(g)}else{e=o.createElement("script");e.type="text/javascript";e.async=l;e.defer=l;e.src=a;var i=o.getElementsByTagName("script")[0];i.parentNode.insertBefore(e,i)}}};h.prototype.La=function(a){function b(a,b){c.a(a,
function(a){this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],f=[],j=[];c.a(a,function(a){a&&(d=a[0],"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&-1!==d.indexOf("track")&&"function"===typeof this[d]?j.push(a):f.push(a))},this);b(e,this);b(f,this);b(j,this)};h.prototype.push=function(a){this.La([a])};h.prototype.disable=function(a){"undefined"===typeof a?this.P.bd=l:this.Ia=this.Ia.concat(a)};h.prototype.s=ca(function(a,b,d){"function"!==typeof d&&(d=C());if(c.d(a))q.error("No event name provided to mixpanel.track");
else if(this.sb(a))d(0);else{b=b||{};b.token=this.c("token");var e=this.persistence.td(a);c.d(e)||(b.$duration=parseFloat((((new Date).getTime()-e)/1E3).toFixed(3)));this.persistence.qc(o.referrer);this.c("store_google")&&this.persistence.Ld();this.c("save_referrer")&&this.persistence.nb(o.referrer);b=c.extend({},c.info.ia(),this.persistence.ia(),b);e=this.c("property_blacklist");c.isArray(e)?c.a(e,function(a){delete b[a]}):q.error("Invalid value for property_blacklist config: "+e);a=c.truncate({event:a,
properties:b},255);e=c.oa(a);e=c.Cb(e);q.log("MIXPANEL REQUEST:");q.log(a);this.m(this.c("api_host")+"/track/",{data:e},this.sa(d,a));return a}});h.prototype.mc=function(a){if(c.d(a))a=o.location.href;this.s("mp_page_view",c.info.rd(a))};h.prototype.Kd=function(){return this.Ra.call(this,D,arguments)};h.prototype.Jd=function(){return this.Ra.call(this,M,arguments)};h.prototype.Fd=function(a){c.d(a)?q.error("No event name provided to mixpanel.time_event"):this.sb(a)||this.persistence.Ad(a)};h.prototype.ja=
...
(this.config.persistence_name=this.config.cookie_name),this.c("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),this.persistence&&this.persistence.pc(this.config),A=A||this.c("debug")};h.prototype.c=function(a){return this.config[a]};h.prototype.xa=function(a){return this.persistence.props[a]};h.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};h.prototype.sb=function(a){return c.Vb(w)||this.P.bd||c.Sb(this.Ia,a)};h.prototype.pb=
ca(function(a){if(a&&!this.P.bb&&!this.c("disable_notifications")){q.log("MIXPANEL NOTIFICATION CHECK");var b=this;this.m(this.c("api_host")+"/decide/",{verbose:l,version:"2",lib:"web",token:this.c("token"),distinct_id:a},this.sa(function(a){a.notifications&&0<a.notifications.length&&b.Ab.call(b,a.notifications[0])}))}});h.prototype.Ab=function(a){(new g(a,this)).show()};h.prototype.Jc=function(){"localStorage"===this.c("opt_out_tracking_persistence_type")&&c.localStorage.gb()&&(!this.$a()&&this.$a({persistence_type:"cookie"})&&
...
secure_cookie:this.c("secure_cookie")},b);c.localStorage.gb()||(b.persistence_type="cookie");return a(this.c("token"),{s:b.track,Gd:b.track_event_name,Hd:b.track_properties,dc:b.persistence_type,cc:b.cookie_prefix,Kb:b.cookie_expiration,Lb:b.cross_subdomain_cookie,yd:b.secure_cookie})};h.prototype.ac=function(a){this.Z(ma,a);this.ta()};h.prototype.jb=function(a){a=c.extend({delete_user:l},a);a.delete_user&&this.people&&this.people.Oa()&&(this.people.Nb(),this.people.Ib());this.Z(na,a);this.ta()};
...
b({status:-1,error:m}):b(-1)),e;q.log("MIXPANEL PEOPLE REQUEST:");q.log(e);this.i.m(this.aa("api_host")+"/engage/",{data:d},this.i.sa(b,e));return e};n.prototype.aa=function(a){return this.i.c(a)};n.prototype.Oa=function(){return this.i.P.bb===l};n.prototype.Cc=function(a){"$set"in a?this.i.persistence.H("$set",a):"$set_once"in a?this.i.persistence.H("$set_once",a):"$unset"in a?this.i.persistence.H("$unset",a):"$add"in a?this.i.persistence.H("$add",a):"$append"in a?this.i.persistence.H("$append",
a):"$union"in a?this.i.persistence.H("$union",a):q.error("Invalid call to _enqueue():",a)};n.prototype.$=function(a,b,d,e){var f=this,g=c.extend({},this.i.persistence.Ma(a)),h=g;!c.d(g)&&c.k(g)&&!c.eb(g)&&(f.i.persistence.I(a,g),e&&(h=e(g)),b.call(f,h,function(b,e){0===b&&f.i.persistence.H(a,g);c.d(d)||d(b,e)}))};n.prototype.Fc=function(a,b,d,e,f,g){var h=this,i=this.i.persistence.Ma("$append");this.$("$set",this.set,a);this.$("$set_once",this.ic,e);this.$("$unset",this.oc,g,function(a){return c.keys(a)});
this.$("$add",this.Tb,b);this.$("$union",this.nc,f);if(!c.d(i)&&c.isArray(i)&&i.length){for(var n,a=function(a,b){0===a&&h.i.persistence.H("$append",n);c.d(d)||d(a,b)},b=i.length-1;0<=b;b--)n=i.pop(),h.append(n,a);h.i.persistence.save()}};n.prototype.S=function(a){return"$distinct_id"===a||"$token"===a};h.yc=function(a,b){c.Eb(this);this.ib=b;this.lb=this.ib.persistence;this.B=c.K(a.id);this.Yb=c.K(a.message_id);this.body=(c.K(a.body)||"").replace(/\n/g,"<br/>");this.ad=c.K(a.cta)||"Close";this.ga=
c.K(a.type)||"takeover";this.style=c.K(a.style)||"light";this.title=c.K(a.title)||"";this.la=g.xc;this.X=g.wc;this.da=a.cta_url||m;this.cb=a.image_url||m;this.L=a.thumb_image_url||m;this.Ea=a.video_url||m;this.va=l;if(!this.da)this.da="#dismiss",this.va=r;this.u="mini"===this.ga;if(!this.u)this.ga="takeover";this.qd=!this.u?g.Y:g.Fa;this.zb();this.ya=this.Kc();this.Nc()};g=h.yc;g.M=200;g.w="mixpanel-notification";g.ma=0.6;g.G=25;g.pa=200;g.Y=388;g.Fa=420;g.z=85;g.Ga=5;g.J=60;g.Ha=Math.round(g.J/2);
g.xc=595;g.wc=334;g.prototype.show=function(){var a=this;this.zb();this.p?(this.Mc(),this.Lc(),this.Rc(this.Ac)):setTimeout(function(){a.show()},300)};g.prototype.Wa=c.l(function(){this.Xb||this.xb({invisible:l});var a=this.Cd?this.h("video"):this.Q();if(this.rc)this.Tc("bg","visible"),this.N(a,"exiting"),setTimeout(this.yb,g.M);else{var b,c,e;this.u?(b="right",c=20,e=-100):(b="top",c=g.G,e=g.pa+g.G);this.qa([{q:this.h("bg"),o:"opacity",start:g.ma,j:0},{q:a,o:"opacity",start:1,j:0},{q:a,o:b,start:c,
j:e}],g.M,this.yb)}});g.prototype.N=c.l(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.h(a));a.className?~(" "+a.className+" ").indexOf(" "+b+" ")||(a.className+=" "+b):a.className=b});g.prototype.Tc=c.l(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.h(a));if(a.className)a.className=(" "+a.className+" ").replace(" "+b+" ","").replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});g.prototype.qa=c.l(function(a,b,c,e){var f=this,g=r,h,i;h=1*new Date;var n,e=e||h;n=h-e;for(h=0;h<a.length;h++){i=
a[h];if("undefined"===typeof i.F)i.F=i.start;if(i.F!==i.j){var g=l,o=i.j>=i.start?1:-1;i.F=i.start+(i.j-i.start)*n/b;if("opacity"!==i.o)i.F=Math.round(i.F);if(0<o&&i.F>=i.j||0>o&&i.F<=i.j)i.F=i.j}}if(g){for(h=0;h<a.length;h++)i=a[h],i.q&&(i.q.style[i.o]=""+i.F+("opacity"===i.o?"":"px"));setTimeout(function(){f.qa(a,b,c,e)},10)}else c&&c()});g.prototype.Ac=c.l(function(){var a=this;if(!this.Dd&&!this.ub()[this.B])this.Dd=l,this.p.appendChild(this.ha),setTimeout(function(){var b=a.Q();if(a.rc)a.u||
a.N("bg","visible"),a.N(b,"visible"),a.wb();else{var c,e,f;a.u?(c="right",e=-100,f=20):(c="top",e=g.pa+g.G,f=g.G);a.qa([{q:a.h("bg"),o:"opacity",start:0,j:g.ma},{q:b,o:"opacity",start:0,j:1},{q:b,o:c,start:e,j:f}],g.M,a.wb)}},100),c.C(a.h("cancel"),"click",function(b){b.preventDefault();a.Wa()}),c.C(a.h("button")||a.h("mini-content"),"click",function(b){b.preventDefault();a.W?(a.Sa("$campaign_open",{$resource_type:"video"}),a.Uc()):(a.Wa(),a.va&&a.Sa("$campaign_open",{$resource_type:"link"},function(){t.location.href=
a.da}))})});g.prototype.h=function(a){return o.getElementById(g.w+"-"+a)};g.prototype.Q=function(){return this.h(this.ga)};g.prototype.ub=function(){return this.lb.props.__cmpns||(this.lb.props.__cmpns={})};g.prototype.O=function(a,b){return this.A[a]&&this.A[a]<=b};g.prototype.Kc=function(){var a=[];this.u?(this.L=this.L||"//cdn.mxpnl.com/site_media/images/icons/notifications/mini-news-dark.png",a.push(this.L)):(this.cb?(a.push(this.cb),this.Rb='<img id="img" src="'+this.cb+'"/>'):this.Rb="",this.L?
...
this.sc&&(b="//player.vimeo.com/video/"+this.sc+"?autoplay=1&title=0&byline=0&portrait=0");if(this.W)this.Pd='<iframe id="'+g.w+'-video-frame" width="'+this.la+'" height="'+this.X+'"  src="'+b+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>',c='<div id="video-'+(this.Za?"":"no")+'flip"><div id="video"><div id="video-holder"></div>'+c+"</div></div>";b=c+a;this.Za&&(b=(this.u?a:"")+'<div id="flipcontainer"><div id="flipper">'+(this.u?c:b)+"</div></div>");
this.ha.innerHTML=('<div id="overlay" class="'+this.ga+'"><div id="campaignid-'+this.B+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+g.w+"-").replace(/id=\"/g,'id="'+g.w+"-")};g.prototype.Mc=function(){this.g="dark"===this.style?{Ua:"#1d1f25",ba:"#282b32",ua:"#3a4147",Db:"#4a5157",Yc:"#32353c",Hb:"0.4",hb:"#2a3137",Ca:"#fff",mb:"#9498a3",jc:"#464851",Ba:"#ddd"}:{Ua:"#fff",ba:"#e7eaee",ua:"#eceff3",Db:"#f5f5f5",Yc:"#e4ecf2",Hb:"1.0",hb:"#fafafa",
...
d.replace(/#/g,"#"+g.w+"-").replace(/\./g,"."+g.w+"-"),b=b+("\n"+e+" {"),e=a[d],f;for(f in e)b+=f+":"+e[f]+";";b+="}"}return b}var d=c(a)+function(a){var b="",d;for(d in a)b+="\n"+d+" {"+c(a[d])+"\n}";return b}(b),e=o.head||o.getElementsByTagName("head")[0]||o.documentElement,f=o.createElement("style");e.appendChild(f);f.setAttribute("type","text/css");f.styleSheet?f.styleSheet.cssText=d:f.textContent=d})(a,h)};g.prototype.Nc=c.l(function(){if(this.Ea){var a=this;a.uc="postMessage"in t;a.da=a.Ea;
...
message_id:this.Yb,type:"web",time:new Date}})});g.prototype.Rc=function(a){var b=this;if(0===this.ya.length)a();else{for(var c=0,e=[],f=function(){c++;c===b.ya.length&&a&&(a(),a=m)},g=0;g<this.ya.length;g++){var h=new Image;h.onload=f;h.src=this.ya[g];h.complete&&f();e.push(h)}this.O("ie",7)&&setTimeout(function(){var b=l;for(g=0;g<e.length;g++)e[g].complete||(b=r);b&&a&&(a(),a=m)},500)}};g.prototype.yb=c.l(function(){t.clearInterval(this.Wc);this.ha.style.visibility="hidden";this.p.removeChild(this.ha)});
...
g.prototype.Uc=c.l(function(){function a(){t.YT&&t.YT.loaded&&b.Bb();b.Cd=l;b.Q().style.visibility="hidden"}var b=this,c=[{q:b.Q(),o:"opacity",start:1,j:0},{q:b.Q(),o:"top",start:g.G,j:-500},{q:b.h("video-noflip"),o:"opacity",start:0,j:1},{q:b.h("video-noflip"),o:"top",start:2*-b.X,j:0}];if(b.u){var e=b.h("bg"),f=b.h("overlay");e.style.width="100%";e.style.height="100%";f.style.width="100%";b.N(b.Q(),"exiting");b.N(e,"visible");c.push({q:b.h("bg"),o:"opacity",start:0,j:g.ma})}b.h("video-holder").innerHTML=
b.Pd;b.Za?(b.N("flipper","flipped"),setTimeout(a,g.M)):b.qa(c,g.M,a)});g.prototype.Sa=function(a,b,d){this.B?(b=b||{},b=c.extend(b,{campaign_id:this.B,message_id:this.Yb,message_type:"web_inapp",message_subtype:this.ga}),this.ib.track(a,b,d)):d&&d.call()};g.prototype.Bb=c.l(function(){var a=this;if(!a.Qd){a.Qd=l;var b=a.h("video-elapsed"),d=a.h("video-time"),e=a.h("video-progress");new t.YT.Player(g.w+"-video-frame",{events:{onReady:function(f){function g(a){var a=Math.round(i-a),b=Math.floor(a/60),
c=Math.floor(b/60),a=a-60*b;d.innerHTML="-"+(c?c+":":"")+("00"+(b-60*c)).slice(-2)+":"+("00"+a).slice(-2)}var h=f.target,i=h.getDuration();g(0);a.Wc=t.setInterval(function(){var a=h.getCurrentTime();b.style.width=100*(a/i)+"%";g(a)},250);c.C(e,"click",function(a){a=Math.max(0,a.pageX-e.getBoundingClientRect().left);h.seekTo(i*a/e.clientWidth,l)})}}})}});h.prototype.init=h.prototype.V;h.prototype.reset=h.prototype.reset;h.prototype.disable=h.prototype.disable;h.prototype.time_event=h.prototype.Fd;
h.prototype.track=h.prototype.s;h.prototype.track_links=h.prototype.Kd;h.prototype.track_forms=h.prototype.Jd;h.prototype.track_pageview=h.prototype.mc;h.prototype.register=h.prototype.ja;h.prototype.register_once=h.prototype.D;h.prototype.unregister=h.prototype.Da;h.prototype.identify=h.prototype.ab;h.prototype.alias=h.prototype.Xc;h.prototype.name_tag=h.prototype.pd;h.prototype.set_config=h.prototype.gc;h.prototype.get_config=h.prototype.c;h.prototype.get_property=h.prototype.xa;h.prototype.get_distinct_id=
...
p.prototype.nb;p.prototype.get_cross_subdomain=p.prototype.jd;p.prototype.clear=p.prototype.clear;n.prototype.set=n.prototype.set;n.prototype.set_once=n.prototype.ic;n.prototype.unset=n.prototype.oc;n.prototype.increment=n.prototype.Tb;n.prototype.append=n.prototype.append;n.prototype.union=n.prototype.nc;n.prototype.track_charge=n.prototype.Id;n.prototype.clear_charges=n.prototype.Ib;n.prototype.delete_user=n.prototype.Nb;n.prototype.toString=n.prototype.toString;c.ud(h);var z={};(function(){V=1;
