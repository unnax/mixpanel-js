...
r;if(!Z)return this.Ja.push([a,b]),r;var c=(new a).V(this);return c.s.apply(c,b)};h.prototype.sa=function(a,b){if(c.d(a))return m;if(U)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.c("callback_fn")+"["+e+"]";d[e]=function(c){delete d[e];a(c,b)};return f};h.prototype.m=function(a,b,d){var e=-1!==a.indexOf("decide")?"GET":"POST";if($)this.Ka.push(arguments);else{var f=this.c("verbose");b.verbose&&(f=l);this.c("test")&&(b.test=1);f&&(b.verbose=1);this.c("img")&&
(b.img=1);if(!U)if(d)b.callback=d;else if(f||this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();a=ra(e,a,b);if("img"in b)e=o.createElement("img"),e.src=a,o.body.appendChild(e);else if(U)try{var j=new XMLHttpRequest;j.open(e,a,l);c.a(this.c("xhr_headers"),function(a,b){j.setRequestHeader(b,a)});j.setRequestHeader("Content-type","application/x-www-form-urlencoded");j.withCredentials=l;j.onreadystatechange=function(){if(4===j.readyState)if(200===j.status){if(d)if(f){var a;
try{a=c.na(j.responseText)}catch(b){q.error(b);return}d(a)}else d(Number(j.responseText))}else a="Bad HTTP status: "+j.status+" "+j.statusText,q.error(a),d&&(f?d({status:0,error:a}):d(0))};"POST"===e?j.send(b.data?"data="+btoa("["+atob(b.data)+"]"):void 0):j.send()}catch(g){q.error(g)}else{e=o.createElement("script");e.type="text/javascript";e.async=l;e.defer=l;e.src=a;var i=o.getElementsByTagName("script")[0];i.parentNode.insertBefore(e,i)}}};h.prototype.La=function(a){function b(a,b){c.a(a,function(a){this[a[0]].apply(this,
a.slice(1))},b)}var d,e=[],f=[],j=[];c.a(a,function(a){a&&(d=a[0],"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&-1!==d.indexOf("track")&&"function"===typeof this[d]?j.push(a):f.push(a))},this);b(e,this);b(f,this);b(j,this)};h.prototype.push=function(a){this.La([a])};h.prototype.disable=function(a){"undefined"===typeof a?this.P.bd=l:this.Ia=this.Ia.concat(a)};h.prototype.s=ca(function(a,b,d){"function"!==typeof d&&(d=C());if(c.d(a))q.error("No event name provided to mixpanel.track");
